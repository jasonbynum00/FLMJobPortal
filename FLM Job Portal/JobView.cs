...
namespace FLM_Job_Portal
{
    public partial class JobView : Form
    {
        ...
        public JobView(string passedJob)
        {
            InitializeComponent();
        ...
        private void CreateUserGB(int i, int iDNum, string empName)
        {
            ...
            gB.ForeColor = Color.LightYellow;
            gB.Width = 723;
            gB.Height = 325;
            ...
            //ADD GENERATED LISTVIEW ITEMS CONTAINING A EMPLOYEES WORK INTO THE CREATED LIST VIEW
            ...
            try
            {
                ...
                {                   
                    ...
                    while (readerComp.Read())
                    {
                        ...
                        //CREATES ROW FOR EACH ITEM OF WORK FOR THE PASSED USER AND ADDS IT TO ARRAY OF ROWS
                        string[] row = { itemComp, departmentComp};
        ...
        //OPENS EDIT EDIT EMPLOYEE FORM
        private void pbEditWork_Click(object sender, EventArgs e)
        {
            EditEmployee theEditor = new EditEmployee(theJob);
